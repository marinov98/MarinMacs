...
** Why Make This Into More Of aGuide?
...
- All the packages should install and configure automatically (power of use-package), **however** you would still have to install the **langauge servers** (instructions below) if you want autocomplete
* Possible-Issues 
...
* General Settings 
 ...
 :CUSTOM_ID: settings
 :END:
I like to use [[https://github.com/tonsky/FiraCode][Fire Code]] font
